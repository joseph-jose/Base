...
<!-- #INCLUDE virtual="/class_sample/cLibrary.asp" -->
<!-- #INCLUDE virtual="/class_sample/cBook.asp" -->
<!-- #INCLUDE virtual="/class_sample/cAuthor.asp" -->
<!-- #INCLUDE virtual="/class_sample/i_helper.asp" -->
