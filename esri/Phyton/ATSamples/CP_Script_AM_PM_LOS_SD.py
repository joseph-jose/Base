...
if __name__ == '__main__':
    ...
    '''User Input'''
    current_month = '2018/09' #arcpy.GetParameterAsText(0)
    previous_month = '2017/09' #arcpy.GetParameterAsText(1)

    '''Data Inputs'''
    input_segments = r'Database Connections\EXT-PROD atalgissdbp01.sde\EXT.GISADMIN.Snitch_RouteSegment_XR'
    input_table = r'Database Connections\EXT-PROD atalgissdbp01.sde\EXT.GISADMIN.Snitch_AttributeDataMonthly_XR'
    diff_table = r'\\atalgisau01\PROJECTS\AT18\Snitch_Monthly_Process\ProjectData.gdb\Speed_Diff_Sep2017_Sep2018'
